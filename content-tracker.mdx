...
- **Develop the idea**: a small disclosure under the seed. Open it to jot your rough thinking, the angle, story beats, whatever's in your head. Everything you write here feeds **Write for me**, so a messy paragraph of real thoughts beats a blank box every time.
